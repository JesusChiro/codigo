...
function totalDePelicula() {
  return peliculas.length;
}
console.log("total de peliculas", totalDePelicula());
//Ejericicio 2
//funcion que devuelve el nombre de la pelicual con mayor
//popularidad
//Hint: campo a analizar _popularity_
//Iterar todas las peliculas guardando:
//1. el index o posicion de la pelicula con
//mayor popularidad
//2 el valor de mayor popularidad como tal

function devolverPeliculaMasPopularidad() {
  let popularity = 0;
  let posicionMP = -1;
  for (i = 0; i < peliculas.length; i++) {
    if (peliculas[i].popularity > popularity) {
...
console.log("La pelicula mas popular es:", devolverPeliculaMasPopularidad());

// Ejercicio 3:
//  Funcion que retorna el nombre de la pelicula con mas generos
// function devolverPeliculaMasGeneros() {
//     let genero = 0;
//     let posicionMP = -1;
//     for (i = 0; i < peliculas.length; i++) {
...
// console.log(peliculas[2].genre_ids.length);

// Ejercicio 4:
// Funcion que imprime los generos a los q pertenece la primera
// pelicula es la decir, la pelicula de la posicion 0

function generosDeLaPrimeraPeliculas() {
  const generosPeliculas0 = peliculas[0].genre_ids;
  for (i = 0; i < generosPeliculas0.length; i++) {
    const generoIDActual = generosPeliculas0[i];
