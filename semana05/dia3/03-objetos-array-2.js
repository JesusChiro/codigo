...
//Ejercicio para filtrsr todos lo s numeros pares
...
//Ejercicio para filtrar a los usuarios con
//correo gmail
let users = [
  {
    id: 1,
...
console.log("Usuarios Gmail", usuariosGmail);

const usuariosGmailV2 = users.filter(({ email }) => email.includes("@gmail"));
console.log("Usuarios Gmail v2", usuariosGmailV2);
...
/**
 * [].reduce((sumatoria, elementoActual)=>{return la
 * sumatoria + el nuevo elemento})
 */
//Ejercicio para obtener una suma de todos los
//numeros del arreglo numeros
...
/**
 * [].splice(posicion, cantidadElementosAEliminar, elementosAInsertar?)
 */

//Elilminar al user de la posicion 4, y en su lugar,
//insertaremos un nuevo usuario
